	...
	(0, _createClass3.default)(Shardable, [{
		...
		value: function createNextIdFunction() {
			...
			return new _bluebird2.default(function (resolve, reject) {
				...
				_this.knex.raw(sql).then(function (results) {
		...
		value: function dropNextIdFunction() {
			...
			return new _bluebird2.default(function (resolve, reject) {
				...
				_this2.knex.raw(sql).then(function (results) {
					return resolve(results);
				}).catch(function (err) {
					return reject(err);
				});
		...
		value: function setShardPrimaryKey(tableName) {
			...
			return new _bluebird2.default(function (resolve, reject) {
				var user = owner === null ? _this3.knex.client.config.connection.user : owner;
				...
				_this3.knex.raw(sql).then(function (results) {
					return resolve(results);
				}).catch(function (err) {
					return reject(err);
				});
		...
		value: function dropSequence(tableName) {
			...
			return new _bluebird2.default(function (resolve, reject) {
				...
				_this4.knex.raw(sql).then(function (results) {
					return resolve(results);
				}).catch(function (err) {
					return reject(err);
				});
